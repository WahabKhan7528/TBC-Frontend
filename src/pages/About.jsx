        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card>
            ...
            <p className="text-gray-600">
              To be the leading educational institution in Pakistan, recognized for
              academic excellence, innovation, and the success of our graduates in
              their chosen fields.
            </p>
          </Card>
          <Card>
            ...
            <p className="text-gray-600">
              ...
              skills, and values necessary for professional success and personal
              growth while contributing positively to society.
            </p>
          </Card>
        </div>
      </Section>
