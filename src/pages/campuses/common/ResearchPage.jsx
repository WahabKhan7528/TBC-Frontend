  ...
  const researchFacilities = [
    {
      ...
      equipment: ['High-Performance Computers', 'GPU Clusters', 'AI Development Tools'],
    },
    {
      name: 'Medical Research Center',
      equipment: ['Electron Microscopes', 'Cell Culture Facility', 'Clinical Trial Units'],
    },
    {
      name: 'Legal Research Library',
      equipment: ['Digital Law Libraries', 'Case Study Databases', 'Legal Documentation Center'],
    },
  ];
    ...
    <div>
            ...
            <div key={area.title}>
              ...
              <Slider>
                {area.projects.map((project) => (
                  <Card key={project.name} className="min-w-[300px] md:min-w-[400px]">
      ...
      <Section className="bg-gray-50">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {researchFacilities.map((facility) => (
