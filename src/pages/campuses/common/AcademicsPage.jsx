      ...
      courses: [
        {
          ...
          description: 'Comprehensive program covering core sciences and specialized subjects.',
        },
        {
      ...
      courses: [
        {
          ...
          description: 'Advanced studies with research opportunities in specialized fields.',
        },
        {
          name: 'PhD Programs',
          duration: '4-5 Years',
            ...
            <div key={program.title}>
              ...
              <Slider>
                {program.courses.map((course) => (
                  <Card key={course.name} className="min-w-[300px] md:min-w-[400px]">
