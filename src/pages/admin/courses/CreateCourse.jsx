    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white border rounded-2xl shadow-sm p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <FormInput label="Duration" value={form.duration} onChange={(v) => handleChange('duration', v)} placeholder="4 years" />
          <FormInput label="Eligibility" value={form.eligibility} onChange={(v) => handleChange('eligibility', v)} placeholder="Intermediate" />
          <FormInput label="Fee information" value={form.fee} onChange={(v) => handleChange('fee', v)} placeholder="$1200/semester" />
        </div>
